...
try:
    ...
    print(f"Error loading UI files: {e}")
    sys.exit(1)
...
def get_db_connection():
    return msd.connect(host=DB_HOST, user=DB_USER, password=DB_PASSWORD, db=DB_NAME)
...
class Library(QMainWindow, ui):
    ...
    def __init__(self):
        ...
        # self.show_author() # Calling these might fail if tables are empty/don't exist or if UI elements missing
        # self.show_publisher()
        
        # Wrap init calls in try-except to avoid crash on startup if DB is empty
        try:
             self.show_categories()
             self.show_author()
             self.show_publisher()
            ...
            print(f"Initialization error (non-fatal): {e}")
    ...
    def show_day_operations(self):
        try:
            ...
            self.db.close()
             ...
             print(f"Error showing day operations: {e}")
    ...
    def show_client(self):
        try:
            ...
            self.db.close()
             ...
             print(f"Error showing clients: {e}")
    ...
    def show_author(self):
        try:
            ...
            if data:
             ...
             print(f"Error showing authors: {e}")
    ...
    def show_publisher(self):
        try:
            ...
            if data:
             ...
             print(f"Error showing publishers: {e}")
